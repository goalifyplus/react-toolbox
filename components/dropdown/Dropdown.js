...
import rootTheme from 'react-toolbox/lib/dropdown/theme.scss';
...
const factory = (Input) => {
  class Dropdown extends Component {
    ...
    handleFocus = (event) => {
      ...
      if (!this.props.disabled && this.state.active) this.open(event);
...
const ThemedDropdown = themr(DROPDOWN, rootTheme)(Dropdown);
